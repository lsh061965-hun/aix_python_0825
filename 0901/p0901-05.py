...
# stu_list[0][2] = 86
# stu_list[0][3] = 78
# stu_list[0][5] = stu_list[0][2]+stu_list[0][3]+stu_list[0][4]
# stu_list[0][6] = stu_list[0][5]/3
# print(stu_list)

names = ["홍길동","유관순","이순신","강감찬","김구"]

while True:
    in_name = input("검색할 이름을 입력하시오 : ")
    if in_name in names:            # 있는지 확인 후 index를 확인하여야 한다.
        no = names.index(in_name)   # index는 없을시 에러발생
        print(no,"학생이 검색되었습니다.")
        change = input("변경할 이름을 입력하시오 : ")
        names[no] = change
